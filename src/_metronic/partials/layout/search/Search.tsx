      ...
      >
        ...
        >
          <div className='btn btn-icon btn-active-light-primary w-30px h-30px w-md-40px h-md-40px'>
            <KTSVG path='/media/icons/gen032.svg' className='svg-icon-1' />
          </div>
        </div>
          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <KTSVG path='/media/icons/com009.svg' className='svg-icon-1' />
                </div>
                ...
                >
                  <div className='symbol symbol-40px me-4'>
                    <span className='symbol-label bg-light'>
                      <img
                        className='w-20px h-20px'
                        src={toAbsoluteUrl('/media/icon/com012.svg')}
                        alt=''
                      />
                    </span>
                  </div>
